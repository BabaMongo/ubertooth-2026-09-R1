#!/usr/bin/env python3
"""
Ubertooth One – Complete Control GUI (i18n Edition) [2026-09-R1]
=================================================================
...
SECURITY (2026-09-R1):
  - All unsafe sprintf() calls replaced with snprintf()
...
class Translator:
    ...
    def _register_builtin_en(self):
        self._register("en", "English", {
            "app.title": "Ubertooth One – Complete Control [2026-09-R1]",
            ...
            "note.version": "2026-09-R1: Security hardened build with buffer overflow protection",
        })
    ...
    def _register_builtin_de(self):
        self._register("de", "Deutsch", {
            ...
            "note.version": "2026-09-R1: Sicherheits-gehärteter Build mit Buffer-Overflow-Schutz",
        })
...
class UbertoothApp:
    ...
    def init_device(self):
        try:
            require_root()
            self.log("Ubertooth Tool 2026-09-R1 – Security-hardened build", "INFO")
