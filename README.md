...
The latest release is [2026-09-R1](https://github.com/greatscottgadgets/ubertooth/releases/tag/2026-09-R1).
The latest firmware build can be found on the release page.

This release is paired with [libbtbb 2026-09-R1](https://github.com/greatscottgadgets/libbtbb/releases/tag/2026-09-R1).
